...
function s.initial_effect(c)
	...
	e3:SetCode(EFFECT_UNRELEASABLE_SUM+EFFECT_UNRELEASABLE_EFFECT)
	e3:SetValue(1)
	c:RegisterEffect(e3)
    local e32=e3:Clone()
	e32:SetCode(EFFECT_UNRELEASABLE_NONSUM)
